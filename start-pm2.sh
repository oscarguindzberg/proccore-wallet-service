...
pm2 stop all
pm2 start --name locker locker/locker.js
pm2 start --name messagebroker messagebroker/messagebroker.js
pm2 start --name bcmonitor bcmonitor/bcmonitor.js
pm2 start --name emailservice emailservice/emailservice.js
pm2 start --name pushnotificationsservice pushnotificationsservice/pushnotificationsservice.js
pm2 start --name fiatrateservice fiatrateservice/fiatrateservice.js
pm2 start --name  bws  bws.js